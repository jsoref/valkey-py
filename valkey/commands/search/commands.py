...
class SearchCommands:
    ...
    def create_index(
        ...
        For more information see `FT.CREATE <https://valkey.io/commands/ft.create>`_.
        """  # noqa
        ...
        args.append("SCHEMA")
        try:
            args += list(itertools.chain(*(f.valkey_args() for f in fields)))
        except TypeError:
            args += fields.valkey_args()
    ...
    def alter_schema_add(self, fields: List[str]):
        ...
        For more information see `FT.ALTER <https://valkey.io/commands/ft.alter>`_.
        """  # noqa
    ...
    def dropindex(self, delete_documents: bool = False):
        ...
        For more information see `FT.DROPINDEX <https://valkey.io/commands/ft.dropindex>`_.
        """  # noqa
    ...
    def explain(
        ...
        For more information see `FT.EXPLAIN <https://valkey.io/commands/ft.explain>`_.
        """  # noqa
    ...
    def aggregate(
        ...
        **query**: This can be either an `AggregateRequest`, or a `Cursor`
        ...
        For more information see `FT.AGGREGATE <https://valkey.io/commands/ft.aggregate>`_.
        """  # noqa
        if isinstance(query, AggregateRequest):
    ...
    def dict_add(self, name: str, *terms: List[str]):
        ...
        For more information see `FT.DICTADD <https://valkey.io/commands/ft.dictadd>`_.
        """  # noqa
    ...
    def dict_del(self, name: str, *terms: List[str]):
        ...
        For more information see `FT.DICTDEL <https://valkey.io/commands/ft.dictdel>`_.
        """  # noqa
    ...
    def dict_dump(self, name: str):
        ...
        For more information see `FT.DICTDUMP <https://valkey.io/commands/ft.dictdump>`_.
        """  # noqa
    ...
    def config_set(self, option: str, value: str) -> bool:
        ...
        For more information see `FT.CONFIG SET <https://valkey.io/commands/ft.config-set>`_.
        """  # noqa
    ...
    def config_get(self, option: str) -> str:
        ...
        For more information see `FT.CONFIG GET <https://valkey.io/commands/ft.config-get>`_.
        """  # noqa
    ...
    def tagvals(self, tagfield: str):
        ...
        For more information see `FT.TAGVALS <https://valkey.io/commands/ft.tagvals>`_.
        """  # noqa
    ...
    def aliasadd(self, alias: str):
        ...
        For more information see `FT.ALIASADD <https://valkey.io/commands/ft.aliasadd>`_.
        """  # noqa
    ...
    def aliasupdate(self, alias: str):
        ...
        For more information see `FT.ALIASUPDATE <https://valkey.io/commands/ft.aliasupdate>`_.
        """  # noqa
    ...
    def aliasdel(self, alias: str):
        ...
        For more information see `FT.ALIASDEL <https://valkey.io/commands/ft.aliasdel>`_.
        """  # noqa
    ...
    def sugadd(self, key, *suggestions, **kwargs):
        ...
        For more information see `FT.SUGADD <https://valkey.io/commands/ft.sugadd/>`_.
        """  # noqa
    ...
    def suglen(self, key: str) -> int:
        ...
        For more information see `FT.SUGLEN <https://valkey.io/commands/ft.suglen>`_.
        """  # noqa
    ...
    def sugdel(self, key: str, string: str) -> int:
        ...
        For more information see `FT.SUGDEL <https://valkey.io/commands/ft.sugdel>`_.
        """  # noqa
    ...
    def sugget(
        ...
        For more information see `FT.SUGGET <https://valkey.io/commands/ft.sugget>`_.
        """  # noqa
    ...
    def synupdate(self, groupid: str, skipinitial: bool = False, *terms: List[str]):
        ...
        For more information see `FT.SYNUPDATE <https://valkey.io/commands/ft.synupdate>`_.
        """  # noqa
    ...
    def syndump(self):
        ...
        For more information see `FT.SYNDUMP <https://valkey.io/commands/ft.syndump>`_.
        """  # noqa
