...
class ManagementCommands(CommandsProtocol):
    ...
    def auth(self, password: str, username: Optional[str] = None, **kwargs):
        ...
        For more information see https://valkey.io/commands/auth
        """
        pieces = []
    ...
    def info(
        ...
        The section option is not supported by older versions of Valkey Server,
    ...
    def replicaof(self, *args, **kwargs) -> ResponseT:
        ...
        host port (set to the host and port of a valkey server)
    ...
    def shutdown(
        ...
        **kwargs,
        ...
        """Shutdown the Valkey server.  If Valkey has persistence configured,
    ...
    def waitaof(
        ...
        to the AOF of the local Valkey and/or at least the specified number
        of replicas.
...
class BitFieldOperation:
    ...
    def incrby(
        ...
        :param str overflow: overflow algorithm. Defaults to WRAP, but other
            acceptable values are SAT and FAIL. See the Valkey docs for
...
class BasicKeyCommands(CommandsProtocol):
    ...
    def copy(
        ...
        the ``destination`` key is created in the source Valkey database.
    ...
    def getset(self, name: KeyT, value: EncodableT) -> ResponseT:
        ...
        As per Valkey 6.2, GETSET is considered deprecated.
    ...
    def mget(self, keys: KeysT, *args: EncodableT) -> ResponseT:
        ...
        """
        from valkey.client import EMPTY_RESPONSE
    ...
    def lcs(
        ...
        For more information see https://valkey.io/commands/lcs
        """
        pieces = [key1, key2]
        if len:
            pieces.append("LEN")
...
class AsyncBasicKeyCommands(BasicKeyCommands):
    def __delitem__(self, name: KeyT):
        raise TypeError("Async Valkey client does not support class deletion")

    def __contains__(self, name: KeyT):
        raise TypeError("Async Valkey client does not support class inclusion")

    def __getitem__(self, name: KeyT):
        raise TypeError("Async Valkey client does not support class retrieval")

    def __setitem__(self, name: KeyT, value: EncodableT):
        raise TypeError("Async Valkey client does not support class assignment")
    ...
    def scan(
        ...
        **kwargs,
        ...
        ``_type`` filters the returned values by a particular Valkey type.
            Stock Valkey instances allow for the following types:
...
class SortedSetCommands(CommandsProtocol):
    ...
    def zmpop(
        ...
        named in the ``keys`` list.
        For more information see https://valkey.io/commands/zmpop
        """
        args = [num_keys] + keys
...
class Script:
    ...
    def __init__(self, registered_client: "Valkey", script: ScriptTextT):
    ...
    def __call__(
        ...
        # make sure the Valkey server knows about the script
...
class AsyncScript:
    ...
    def __init__(self, registered_client: "AsyncValkey", script: ScriptTextT):
        self.registered_client = registered_client
        self.script = script
        # Precalculate and store the SHA1 hex digest of the script.
...
class ScriptCommands(CommandsProtocol):
    ...
    def eval(
        ...
        function exists purely for Valkey API completion.
    ...
    def register_script(self: "Valkey", script: ScriptTextT) -> Script:
        """
...
class Script:
    ...
    def get_encoder(self):
        ...
        try:
            ...
            # valkey. ClusteredValkey doesn't have a `.connection_pool` attribute
...
class DataAccessCommands(
    ...
    """
    A class containing all of the implemented data access valkey commands.
    This class is to be used as a mixin for synchronous Valkey clients.
    """
...
class AsyncDataAccessCommands(
    ...
    """
    A class containing all of the implemented data access valkey commands.
    This class is to be used as a mixin for asynchronous Valkey clients.
    """
...
class CoreCommands(
    ...
    """
    A class containing all of the implemented valkey commands. This class is
    to be used as a mixin for synchronous Valkey clients.
    """
...
class AsyncCoreCommands(
    ...
    """
    A class containing all of the implemented valkey commands. This class is
    to be used as a mixin for asynchronous Valkey clients.
    """
