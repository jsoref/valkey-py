...
from valkey.typing import KeyT, Number
...
class TimeSeriesCommands:
    ...
    def create(
        ...
        For more information: https://valkey.io/commands/ts.create/
        """  # noqa
        params = [key]
    ...
    def alter(
        ...
        For more information: https://valkey.io/commands/ts.alter/
        """  # noqa
        params = [key]
        self._append_retention(params, retention_msecs)
        self._append_chunk_size(params, chunk_size)
    ...
    def add(
        ...
        For more information: https://valkey.io/commands/ts.add/
        """  # noqa
    ...
    def madd(self, ktv_tuples: List[Tuple[KeyT, Union[int, str], Number]]):
        ...
        For more information: https://valkey.io/commands/ts.madd/
        """  # noqa
        params = []
    ...
    def incrby(
        ...
        For more information: https://valkey.io/commands/ts.incrby/
        """  # noqa
        params = [key, value]
    ...
    def decrby(
        ...
        For more information: https://valkey.io/commands/ts.decrby/
        """  # noqa
        params = [key, value]
        self._append_timestamp(params, timestamp)
        self._append_retention(params, retention_msecs)
    ...
    def delete(self, key: KeyT, from_time: int, to_time: int):
        ...
        For more information: https://valkey.io/commands/ts.del/
        """  # noqa
    ...
    def createrule(
        ...
        For more information: https://valkey.io/commands/ts.createrule/
        """  # noqa
    ...
    def deleterule(self, source_key: KeyT, dest_key: KeyT):
        ...
        For more information: https://valkey.io/commands/ts.deleterule/
        """  # noqa
    ...
    def range(
        ...
        For more information: https://valkey.io/commands/ts.range/
        """  # noqa
    ...
    def revrange(
        ...
        **Note**: This command is only available since RedisTimeSeries >= v1.4
        ...
        For more information: https://valkey.io/commands/ts.revrange/
        """  # noqa
        params = self.__range_params(
            key,
            from_time,
    ...
    def mrange(
        ...
        For more information: https://valkey.io/commands/ts.mrange/
        """  # noqa
    ...
    def mrevrange(
        ...
        For more information: https://valkey.io/commands/ts.mrevrange/
        """  # noqa
        params = self.__mrange_params(
            aggregation_type,
            bucket_size_msec,
    ...
    def get(self, key: KeyT, latest: Optional[bool] = False):
        ...
        For more information: https://valkey.io/commands/ts.get/
        """  # noqa
        params = [key]
        self._append_latest(params, latest)
    ...
    def mget(
        ...
        For more information: https://valkey.io/commands/ts.mget/
        """  # noqa
        params = []
        self._append_latest(params, latest)
        self._append_with_labels(params, with_labels, select_labels)
    ...
    def info(self, key: KeyT):
        ...
        For more information: https://valkey.io/commands/ts.info/
        """  # noqa
    ...
    def queryindex(self, filters: List[str]):
        ...
        For more information: https://valkey.io/commands/ts.queryindex/
        """  # noq
